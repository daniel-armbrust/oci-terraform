...
module "gru_vmlnx-wordpress_primary" {
    ...
    display_name = "gru_vmlnx-wordpress_primary"
    hostname = "gruwrdpress-p"
...
module "gru_vmlnx-wordpress_backup" {    
    ...
    compartment_id = var.compartment_id
    display_name = "gru_vmlnx-wordpress_backup"
    hostname = "gruwrdpress-b"
