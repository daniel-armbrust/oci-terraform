...
module "gru_drg-attch_vcn-hml" {
    ...
    drg_id = module.gru_drg.id    
    network_id = module.gru_vcn-hml.id
    network_type = "VCN"
    display_name = "gru_drg-attch_vcn-hml"
}

module "gru_drg-attch_vcn-dev" {
    source = "./modules/networking/drg_attachment"
    ...
    drg_id = module.gru_drg.id    
    network_id = module.gru_vcn-dev.id
    network_type = "VCN"
    display_name = "gru_drg-attch_vcn-dev"
}

module "gru_drg-attch_vcn-shared" {
    source = "./modules/networking/drg_attachment"
    ...
    drg_id = module.gru_drg.id    
    network_id = module.gru_vcn-shared.id
    network_type = "VCN"
    display_name = "gru_drg-attch_vcn-shared"
}
    ...
    is_ecmp_enabled = false
     ...
     route_rules = [
        ...
        },
        {
            ...
            nexthop_drg_attachment_id = module.gru_drg-attch_vcn-hml.id
        },
        {
            destination = "10.4.0.0/16"
            nexthop_drg_attachment_id = module.gru_drg-attch_vcn-dev.id
        },
        {
            destination = "10.6.0.0/24"
            nexthop_drg_attachment_id = module.gru_drg-attch_vcn-shared.id
        }
    ]   
}
